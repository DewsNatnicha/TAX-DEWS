...
namespace TAX_DEWS
{
    public partial class Form1 : Form
    {
        ...
        private void gohome_Click(object sender, EventArgs e)
        {
            ...
            Form3 sum = new Form3(TBearn.Text);
            Group1 one = new Group1(TBearn.Text);
            Group2 two = new Group2(TBearn.Text);
            Group3 three = new Group3(TBearn.Text);
            Group4 four = new Group4(TBearn.Text);
            Group5 five = new Group5(TBearn.Text);
            one.Show();
            this.Hide();
        }
    }
