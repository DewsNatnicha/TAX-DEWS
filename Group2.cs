...
namespace TAX_DEWS
{
    public partial class Group2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            g3.g1.Text = g1.Text;
            g3.TBearn.Text = TBall.Text;
            g3.earn.Text = earn.Text;
            g3.g2.Text = TBdeduction.Text;
            g3.Show();
        }

        private void TBsocial_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void TBfamily_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void TBhealth_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void TBfm_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void TBliving_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void TBfund_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
