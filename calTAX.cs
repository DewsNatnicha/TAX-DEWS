...
namespace TAX_DEWS
{
    public partial class calTAX : Form
    {
        ...
        private void BT2_Click(object sender, EventArgs e)
        {
            ...
            openForminpPanel(new Group2(TBearn.Text));
        ...
        private void BT3_Click(object sender, EventArgs e)
        {
            ...
            openForminpPanel(new Group3(TBearn.Text));
        ...
        private void BT4_Click(object sender, EventArgs e)
        {
            ...
            openForminpPanel(new Group4(TBearn.Text));
        ...
        private void BT5_Click(object sender, EventArgs e)
        {
            ...
            openForminpPanel(new Group5(TBearn.Text));
        ...
        {
            Form3 sumForm = new Form3(TBearn.Text);
            sumForm.Show();
            this.Hide();
        }
    }
