    ...
    public partial class Group3 : Form
    {
        ...
        private void BTcal_Click(object sender, EventArgs e)
        {
            ...
            if (RB62.Checked)
            {
                ...
                //รวมลดหย่อนภาษี = ดอกเบี้ยบ้าน+เฉลี่ยต่อปี
                TBsum62.Text = (int.Parse(TBhomesum.Text) + int.Parse(TB62sum.Text)).ToString();
            }
            //รวมค่าลดหย่อน
            if (RB58.Checked)
        ...
        {
            this.Hide();
            Group4 g4 = new Group4(TBearn.Text);
            g4.g1.Text = g1.Text;
            g4.g2.Text = g2.Text;
            g4.g3.Text = TBall.Text;
            g4.Show();
        }
    }
}
